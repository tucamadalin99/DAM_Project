...
public class ExpandLvAdapater extends BaseExpandableListAdapter {

    Context context;
    List<String> listGroup;
    HashMap<String,List<String>> listItem;

    public ExpandLvAdapater(Context context, List<String> listGroup, HashMap<String, List<String>> listItem) {
